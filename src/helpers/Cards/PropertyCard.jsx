...
const PropertyCard = ({ property }) => {
  ...
  const [isHovered, setIsHovered] = useState(false); // สถานะ hover สำหรับการแสดงปุ่ม
  ...
  return (
    <div
      ...
      onMouseLeave={() => setIsHovered(false)} // เมื่อเลิก hover
    >
      <div className="photo-slider">
        <img
          className="homecard-image"
          src={property.images[currentImageIndex]} // แสดงภาพตาม index
